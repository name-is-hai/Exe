    ...
    return (
        <footer className="py-6 mt-12 border-t md:px-8 md:py-0">
            <div className='container my-10'>
                ...
                <div className='flex text-sm'><div>Địa chỉ:</div> <div className='pl-5 text-secondary-foreground'>Tân Xã, Thạch Thất, Hà Nội</div></div>
                <div className='flex text-sm'><div>Fanpage:</div> <div className='pl-5 text-secondary-foreground'><a href="https://www.facebook.com/profile.php?id=100083483767529" target="_blank" rel="noreferrer" className="font-medium underline underline-offset-4">Hòa Lạc House </a></div></div>
                <div className='flex text-sm'><div>Facebook Group:</div> <div className='pl-5 text-secondary-foreground'><a href="https://www.facebook.com/groups/1156910228639296" target="_blank" rel="noreferrer" className="font-medium underline underline-offset-4">Hòa Lạc House </a></div></div>
