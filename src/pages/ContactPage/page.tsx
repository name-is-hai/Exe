  ...
  return (
    <Page>
      <Container className="py-24 lg:px-32">
        <div
          key="1"
          className="p-4 space-y-8 border-2 border-gray-300 rounded-md shadow-md dark:border-gray-700"
        >
            ...
            <Form {...form_contact}>
              <form onSubmit={form_contact.handleSubmit(onSubmitContact)}>
                <div className="grid gap-2">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Hãy điền số điện thoại hoặc email của bạn"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Hãy điền thông điệp bạn muốn gửi đến chúng tôi."
                              {...field}
                              rows={5}
                  ...
                  <Button
                    className="w-full text-black bg-gray-300 dark:bg-gray-700 dark:text-white"
                    disabled={isLoading}
                  >
                    <Show>
