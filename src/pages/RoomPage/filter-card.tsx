          ...
          <Card>
            <CardContent className="p-2 text-center bg-sky-100 dark:bg-slate-800">
              <div className="flex items-center justify-center space-x-2">
                <Tags />
                <div className="text-sm font-medium">Chúng Tôi Luôn Khớp Giá!</div>
              </div>
            </CardContent>
          </Card>
        </HoverCardTrigger>
      ...
      <Card>
        ...
        <CardFooter>
          ...
          >
            ...
            >
              Từ: {numberCurrencyFormat(currentValue[0])}
              {' - '}Đến: {numberCurrencyFormat(currentValue[1])}
            </PopoverContent>
            <PopoverTrigger asChild>
              <Slider
                className="w-full"
                min={1000000}
                onValueChange={sliderPriceChange}
                onValueCommit={handleChange}
                max={10000000}
                defaultValue={[formData.startPrice, formData.endPrice]}
